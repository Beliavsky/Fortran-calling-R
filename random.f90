...
! return 2D array of independent standard normal variates
...
! return a 1D array of Student variates with specified degrees of freedom
integer, intent(in) :: n
real(kind=dp), intent(in) :: dof
real(kind=dp) :: t(n)
integer :: i
...
! return a uniform variate
real(kind=dp) :: r
call random_number(r)
end function runif_scalar

function runif_vec(n) result(r)
! return a 1D array of uniform variates
integer, intent(in)  :: n
...
! return a 3D array of independent uniform variates
integer, intent(in)  :: n1,n2
real(kind=dp), allocatable :: r(:,:)
allocate (r(n1,n2))
call random_number(r)
